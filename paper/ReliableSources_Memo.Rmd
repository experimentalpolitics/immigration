...
We thank the reviewe for their helpful comments etc. We respond to each point below.
...
Refer to Hopkins piece as well as recent Clifford piece on quasi pretest-posttest designs. Show that many people get it wrong in the control group.
...
Check language from other journals
...
- Run logit models: DONE.
- Add logit tables to appendix.
- Add language in main text describing linear probability model. Cite?
- Add reference in main text to logistic regression results.
...
Check evaluation of news articles in the appendix.

## Other stuff

update code: condint vs. confint_tidy
