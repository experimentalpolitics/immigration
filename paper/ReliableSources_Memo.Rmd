...
<!-- - `DONE:` Mention that even if there is a certain level of imbalance, we are including controls for various pre-treatment covariates, so it shouldn't be a problem. -->
