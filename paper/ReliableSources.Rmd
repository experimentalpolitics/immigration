...
<!-- TODO: add discussion of pre-registration, sample characteristics, balance, etc. -->

\noindent Our experiment was administered in December 2019 on Amazon's Mechanical Turk (MTurk). MTurk respondents are generally younger, more liberal, and more likely to identify with the Democratic party than respondents in surveys using nationally representative samples (Huff and Tingely 2015). However, MTurk respondents have been found to be more representative of the American population than other types of convinience samples (Huff and Tingley 2015). Our sample of 600 respondents reflects these dynamics, and summary statistics are provided in the Appendix. <!--note that we need to reference the table specifically once we decide where it lives.-->
