...
In light of the remarkable differences between voluntary and involuntary exposure to inconsistent sources, we have to keep in mind that conditioning on source selection in the free choice condition makes it difficult to provide a clear causal interpretation of the effects. In other words, people who decide to access inconsistent information may be systematically different from people who do not choose to do so. (a) hold systematically different pre-treatment attitudes or (b) respond differently to the information treatment. Approach the treatment in a different way?
...
Note: Most people choose consistent sources if they are given the choice (see Appendix A.II and A.III), so the natural question to ask is what is different about those people 
