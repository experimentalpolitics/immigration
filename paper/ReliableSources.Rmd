...
## The Role of Self-Selection and Attitude Ambivalence[^5]

[^5]: The analyses in this section were not preregistered and should therefore be considered exploratory.

Conditioning on source selection in the free choice condition makes it difficult to provide a clear causal interpretation of the differences between voluntary and involuntary exposure to inconsistent sources. In other words, only people with certain characteristics may self-select to access inconsistent sources and the resulting imbalance in pre-treatment confounders would jeopardize our inferences.[^6] Given that we are working with a between-subjects design, the crucial question then becomes whether people who are willing to access inconsistent sources (a) hold systematically different pre-treatment attitudes or (b) respond differently to the treatment itself?
...
The most straightforward explanation for diverging opinions in response to voluntary and involuntary exposure to inconsistent sources would that both groups have systematically different immigration attitudes to begin with. However, keep in mind tha all our analyses presented hitherto include controls for pre-treatment immigration attitudes, ideology, partisanship, and basic sociodemographics.



For example, this could work if MSNBC viewers are more likely to choose inconsistent sources (since they are more liberal)

The message is pro-immigrant, so it's more coherent with MSNBC narrative than Fox narrative. Balance between Fox News and MSNBC exposure is the same in free-choice and forced exposure condition


In sum, while we cannot fully rule out the possibility that people who self-selected into exposure to an inconsistent source had substantively different pre-treatment attitudes, we view this explanation as less convincing than the argument that they may be more receptive to corrective information.


Explanation 1: Inconsistent sources are picked up by people who prefer MSNBC rather than Fox. But this is not the case, Fox News vs. MSNBC are split evenly among respondents who picked inconsistent exposure in the free choice condition. Furthermore, additional analyses in Appendix B.I suggest that there are no differences in average choice-specific treatment effects between people who prefer Fox or MSNBC [see @knox2019design] and that---if anything---people who usually prefer MSNBC are more critical of the Fox News article than people who usually prefer Fox News are of the MSNBC article.

Explanation 2: People who select inconsistent sources have different pre-treatment attitudes. But we control for pre-treatment attitudes

Explanation 3: People who select inconsistent sources may have more ambivalent attitudes and are therefore more open to attitude change [e.g., @lavine2012ambivalent].
...
SWITCH TO WITHIN-SUBJECTS DESIGN!
