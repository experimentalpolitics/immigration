...
Our analytical strategy to identify treatment effects for each of these outcomes is based upon between-subject comparisons across treatment conditions. By not measuring pre-treatment factual beliefs, we are relying on the fact that most people tend to underestimate the beneficial economic impact of immigration, which is consistent with previous studies exploring the effect of corrective information about immigration [e.g., @hopkins2019muted]. Furthermore, the identification strategy developed in prior implementations of the PICA design relies on between-subject comparisons as well [e.g., @benedictis2019persuading]. Of course, it is always advantageous to rely on within-subject comparisons to maximize statistical power. Unfortunately, such a pure pretest-posttest design would have implied asking respondents a corresponding set of questions before receiving the treatment. This could have jeopardized our treatment itself, since participants may have doubted that they are given a "random" news article if they are asked about the exact same issues prior to reading the article. Following recent recommendations by @clifford2021increasing, however, we incorporate two measures capturing pre-treatment attitudes that should be highly predictive of beliefs, interpretations, and attitudes. These measures were included in a set of distractor items to disguise their connection to the news article.
