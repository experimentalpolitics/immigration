...
Compared to the control condition, the proportion of participants who read the tweet and news story who were able to provide correct responses to the factual questions regarding the employment and total value of sales by immigrant-owned businesses was about 20-30% higher.

The effects are smaller for interpretations and opinions, a result that is consistent with Hypothesis 1.

These results suggest that belief and opinion change as a response to misinformation corrections is relatively common and independent of how people gain access to them. Only if people are allowed to choose their information source, however, do we observe that they change their minds about the issue. While this is at least suggestive evidence that selective exposure and discretion over media diets is a potentially important factor facilitating opinion change, it should be noted that the difference between both treatment effects themselves is not statistically significant [@gelman2006difference]. Overall, however, these results lend at least suggestive support for Hypothesis 2.
