...
Citizens in western democracies hold wide-ranging and systematic misperceptions about immigrants to their home countries. For example, people usually overestimate the total number of immigrants or the proportion of immigrants that are dependent on social welfare [e.g., @alesina2019immigration]. 
<!--SY: While I was reading out paper with fresh eyes, I thought it would be nice to have a line to explain why this is a problem so why various studies, including us, examined the impact of corrective information on people's attitudes. 
"Those misperceptions casued by misinformation and fake news have distorted the immigration debate for years, fostering biased attitudes within certain segments of the citizens [@Wright et al 2019]." -->

Given this extensive spread of misinformation, various studies examined how corrective information may affect people's underlying attitudes towards immigration, albeit with limited success. Although corrective information may alleviate factual misperceptions, it rarely affects people's underlying attitudes [see for example @hopkins2019muted; @thompson2019might].
...
<!--SY: Unless we limit our references to immigration issues but expand to general findings on the role of misinformation and attitudes formation, some good examples in this paper (page 7): https://www.dartmouth.edu/~nyhan/nature-origins-misperceptions.pdf -->
