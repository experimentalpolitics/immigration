...
## Predictive Accuracy of Open-Ended Responses

```{r m8, fig.height=2, fig.width=4.5, fig.cap="\\label{fig:m6}Accuracy of Naive Bayes classifier to predict attitudes based on language in open-ended responses of respondents who were exposed to inconsistent information in the free choice and forced exposure condition."}
