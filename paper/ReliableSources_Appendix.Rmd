...
source("../code/04-predictive-accuracy.R")
source("../code/05-appendix.R")
```
...
# Additional Analyses: Predictive Accuracy in OE responses

```{r m8, fig.height=2, fig.width=4.5, fig.cap="\\label{fig:m6}Difference in tentative language in open-ended responses of respondents who were exposed to inconsistent information in the free choice and forced exposure condition. Tentative words based on LIWC dictionary, including 90\\% (thin line) and 95\\% (thick line) confidence intervals."}
p8
```
...
![Survey flow and overview of the experimental design.](../prereg/Lab-Graphic.jpg)
