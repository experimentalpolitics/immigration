...
**Sharing the article:** After reading the article, participants are asked to report their willingness to share it on social media, discuss it with friends, or if they would be likely to seek out more information regarding the topic of the tweet and story.
...
- **H1a** [control vs. forced exposure]: Participants who are assigned to read a news article update their beliefs and attitudes in the direction of the article.
- **H1b** [control vs. free choice]: Participants who are able to choose a news article update their beliefs and attitudes in the direction of the article.

Next, we want to compare how individuals update their beliefs on immigration when they are either given a choice or are assigned the source from which they receive the information.
We hypothesize that the free choice condition in ultimately more effective than the forced exposure condition:
...
- **H2a:** When free to choose a news organization, conservatives (liberals) are more likely to pick FoxNews (MSNBC).
- **H2b:** When free to choose a news organization, Republicans (Democrats) are more likely to pick FoxNews (MSNBC).
...
- **H3**: Participants who were assigned their preferred media choice will update their beliefs more than those who were assigned to a different news organization.

Additionally, we can estimaate the ACTE following Knox et al.
