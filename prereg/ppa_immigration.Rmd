...
**Economic impact of immigration:** Our first outcome of interest captures the perceived economic impact of legal immigration. The news article includes specific information on the number of people in the US who are employed by immigrant-owned businesses as well as the total amount of sales revenue of immigrant-owned businesses. Our goal is to examine when the news article is effective in correcting common factual misperceptions on these issues (i.e., underestimating the size of immigrant-owned businesses). Two additional questions capture respondents' beliefs about how much immigrants contribute to society by paying taxes and creating jobs (these items will be analyzed individually). 

**Attitudes towards immigration:** Our second outcome measure focuses on people's attitudes towards legal immigration. Specifically, we ask participants whether they think the number of immigrants in the US should be increased or decreased. This item allows us to assess whether the news article not only corrects factual misperceptions but additionally induces attitude change.
...
- **H1a** [control vs. forced exposure]: Participants who are assigned to a random news organization update their beliefs and attitudes in the direction of the article published by the source.
- **H1b** [control vs. free choice]: Participants who are free to choose a news organization update their beliefs and attitudes in the direction of the article published by the source.

Importantly, we want to examine whether allowing people to choose their preferred information source makes corrective information more effective. We therefore hypothesize that the free choice condition in ultimately more effective than the forced exposure condition:

- **H1c** [forced exposure vs. free choice]: Participants who are given the opportunity to choose a news organization are more likely to update their beliefs and attitudes in the direction of the article published by the source.

Note that the last comparison can also be evaluated using the additional outcome measures described above (trust in news sources, engagement with tweet, response latencies, sharing the article, evaluation of the article), which are not included in the control group. For each of these outcomes, we expect that the ability to choose their preferred information source will increase engagement with the article and will ultimately lead to more positive evaluations. We will also examine conditional treatment effects based on people's political predispositions (measured using the pre-treatment stereotype battery: stereotypes towards immigrants, whether immigration is seen as a major issue, and basic political predispositions).
...
Furthermore, we can focus on the forced exposure condition and examine conditional effects differentiating by news sources themselves (i.e., FoxNews vs. MSNBC). As part of the pre-treatment questionnaire, respondents are asked how often they watch political news on various TV channels including. Respondents should be more inclined to believe a report if it is published by a news organization they rely on more regularly.
...
As a first step, analysis would exclude the free choice arm of the experiment and estimate treatment effects based on the randomly assigned news organizations alone. Additionally, we are going to explore the average choice-specific treatment effect (ACTE) following @knox2019design, which captures conditional average treatment effect for the sub-population of subjects who would choose a particular treatment option (i.e., the effect of the article among those who choose FoxNews or MSNBC).
