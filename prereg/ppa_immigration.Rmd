...
We consider several outcome measures to capture immigration attitudes and how the news story is received by participants (see full questions below). Unless otherwise specified, outcomes that are measured using multiple variables will be combined in a additive scale. We are going to ensure that all items load properly on a single factor and exclude those that do not. Furthermore, we will report results using individual items in the appendix.

**Economic impact of immigration:** Our first outcome of interest addresses the perceived economic impact of legal immigration. The news article includes specific information on the number of people in the US who are employed by immigrant-owned businesses as well as the total amount of sales revenue of immigrant-owned businesses. Substantively, we want to examine under what conditions the news article is effective in correcting common factual misperceptions on these issues.

**Attitudes towards immigration:** Our second outcome measure focuses on people's attitudes towards legal immigration. We include one question asking participants whether the number of immigrants should be increased or decreased (this item will be analyzed individually). Two additional questions capture respondents' beliefs about how much immigrants contribute to society by paying taxes and creating jobs. Together, these items will allow us to assess whether the news article not only corrects factual misperceptions but additionally induces attitude change.
...
In addition to these main variables, we evaluate four additional outcomes and conduct a simple manipulation check. Note that by the nature of the design, these items can only be measured in the two treatment arms of the experiment and are not included in the control group.

**Engagement with tweet:** As described above, the tweet shown to participants consists of a link to a news article. While the link itself is not active and participants are never explicitly asked explicitly click on it, we can capture whether participants nevertheless try access the article. Whether they attempt to do so can be used as an unobstrusive measure of the degree to which participants are interested in further engaging with the content voluntarily.

**Response latencies:** In order to further assess the extent to which respondents are interested in the article and comply with the instructions to read it carefully, we will also measure the amount of time that individuals spend viewing the tweet and reading the news story.
...
**Sharing the article:** After reading the article, participants are asked to report their willingness to share it on social media, discuss it with friends, or if they would be likely to seek out more information regarding the topic of the tweet and story [see @benedictis2019persuading for similar items].
...
For the main outcome measures described above (i.e., immigration attitudes and perceived economic impact), our analysis will consist of two comparisons:

- **H1a** [control vs. forced exposure]: Those who receive information from an assigned source are more likely to update their beliefs than those who are in the control group.
- **H1b** [control vs. free choice]: Those who receive information from a chosen sources are more likely to update beliefs than those in the control group.

This measure takes into account the same pre- and post-treatment immigration attitude questions and determines how individuals update their beliefs on immigration when they are either given a choice or are assigned the source from which they receive the information.
Furthermore, we hypothesize that the free choice condition in ultimately more effective than the forced exposure condition, which leads to the following hypothesis:

- **H1c** [forced exposure vs. free choice]: Allowing people to choose their preferred information source makes corrective information more effective. Those participants who are given the opportunity to choose the tweet and article will be more likely to update their beliefs than those who are assigned a source randomly.

Note that the last comparison can also be evaluated using the additional outcome measures described above (trust in news sources, engagement with tweet, response latencies, sharing the article, evaluation of the article)!
...
<!-- assigned source instead of forced exposure  -->

### Analysis within free choice arm of the experiment

Beyond this main analysis comparing the free choice and forced exposure conditions, we are going to examine whether respondents choose information sources that are consistent with their ideological predisposition and usual media diet.

- **H2a:** When free to choose news organizations, conservatives (liberals) are more likely to pick FoxNews (MSNBC).
- **H2b:** When free to choose news organizations, participants who report viewing FoxNews (MSNBC) more regularly are more likely to pick FoxNews (MSNBC).

### Analysis within forced exposure arm of the experiment

Furthermore, we can focus on the forced exposure condition. The next set of comparisons focuses on the sources themselves rather than the delivery method. This part would exclude the free choice arm of the experiment:

- **H3a** [control vs. msnbc]: Participants that were assigned msnbc will update their beliefs more than the control group. 
- **H3a** [control vs. fox]: Participants that were assigned fox will update their beliefs more than the control group.
- **H3a** [msnbc vs. fox]: Participants who were assigned their preferred media choice
...
<!-- QUESTION: how does the ACTE fit in here? -->
