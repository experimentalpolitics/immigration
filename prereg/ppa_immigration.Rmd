...
Note that the last comparison can also be evaluated using the additional outcome measures described above (trust in news sources, engagement with tweet, response latencies, sharing the article, evaluation of the article). For each of these outcomes, we expect that the ability to choose their preferred information source will increase engagement with the article and will ultimately lead to more positive evaluations.

### Analysis within free choice arm of the experiment

Beyond this main analysis comparing the free choice and forced exposure conditions, we are going to examine whether respondents choose information sources that are consistent with their ideological predisposition and usual media diet. Participants are expected to engage in a biased search process, seeking out information that is likely to support their preconceptions and avoiding evidence that undercuts their beliefs [see @Taber2006]. This leads our first set of hypotheses regarding endogenous information search and its effectiveness.
