...
```{r, results= "asis"}
stargazer(lh1, title = "Liberal Immigration Level")
stargazer(lh2, title = "Sales Correct")
stargazer(lh3, title = "Employ Correct")
...
prefer_fox <- dat$tv_msnbc - dat$tv_fox
...
```{r, results='asis'}
stargazer(test, test2, test3, single.row = T, column.sep.width = "0pt")
```
